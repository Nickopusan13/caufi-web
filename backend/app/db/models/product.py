...
from sqlalchemy import String, Integer, DateTime, Boolean, ForeignKey, func, Text, Numeric
...
class ProductMaterial(Base):
    ...
    product: Mapped["Product"] = relationship("Product", back_populates="material", lazy="selectin")
...
class ProductSize(Base):
    ...
    product: Mapped["Product"] = relationship("Product", back_populates="sizes", lazy="selectin")
...
class ProductColor(Base):
    ...
    product_id: Mapped[int] = mapped_column(Integer, ForeignKey("product.id"), nullable=False)
    product: Mapped["Product"] = relationship("Product", back_populates="colors", lazy="selectin")
